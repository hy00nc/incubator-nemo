...
public final class JobConf extends ConfigurationModuleBuilder {
  ...
  /**
   * Maximum off-heap memory size in mb.
   * This should be set by the system according to the off-heap ratio.
   */
  @NamedParameter(doc = "The maximum off-heap memory that can be allocated", default_value = "8192")
