...
public final class BeamWordCountNoFusion {
  ...
  public interface WordCountOptions extends PipelineOptions {
    ...
    @Default.String("/Users/haeyoon/incubator-nemo/examples/resources/inputs/test_input_beam_wordcount")
    String getInputFile();
    ...
    @Default.String("/Users/haeyoon/incubator-nemo/examples/resources/outputs/test_output_beam_wordcount")
    String getOutput();
  ...
  static void runWordCount(final WordCountOptions options) {
    ...
    PCollection<String> result =
      GenericSourceSink.read(p, options.getInputFile())
        .apply(new BeamWordCount.CountWords())
        .apply(MapElements.via(new BeamWordCount.FormatAsTextFn()));
